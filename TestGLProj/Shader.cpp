...
bool Shader::SetUniform(std::string name, glm::vec2 value)
{
	int loc = glGetUniformLocation(m_program, name.c_str());
...
bool Shader::SetUniform(std::string name, glm::ivec2 value)
{
	int loc = glGetUniformLocation(m_program, name.c_str());
...
bool Shader::SetUniform(std::string name, glm::ivec3 value)
{
	int loc = glGetUniformLocation(m_program, name.c_str());
